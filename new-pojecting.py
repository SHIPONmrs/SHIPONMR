# Decompile by Younis (Tools By SHIPON-MRS)
# Time Succes decompile : 2022-06-29 18:44:58.596548
Facebook: https://www.facebook.com/md12qw
...
\033[1;31;1m█ \033[1;92m [•] \033[1;31;1mWhatsapp  :  \033[1;92m Shipon Mrs          \033[1;31;1m █
\033[1;31;1m█ \033[1;92m [•] \033[1;31;1mGitHub    : \033[1;92m  Mrs420_           \033[1;31;1m █
\033[1;31;1m█ \033[1;92m [•] \033[1;31;1mGorup Fb  :   \033[1;92mNot Found\033[1;31;1m █
    ...
    if len(ok) != 0 or len(cp) != 0:
        ...
        if cek_cp =="":
            ...
            for memek in cp:
                ...
                titid  = kontol.split(' • ')
                print(f'{N}══════════════════════════════════════════\n {H}LOGIN PROCESS')
                jalan(f' {N}[{M}?{N}] Account : {K}{kontol.replace("[MRS-CP] ", "")}{N}')
                try:
